...
const (
	baseURL        = "https://api.apiverve.com/v1/sslchecker"
	defaultTimeout = 30 * time.Second
)

// Client is the SSL Certificate Checker API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new SSL Certificate Checker API client.
...
// Execute makes a request to the SSL Certificate Checker API with typed parameters.
//
