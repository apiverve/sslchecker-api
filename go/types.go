// Package sslchecker provides a Go client for the SSL Certificate Checker API.
//
// For more information, visit: https://sslchecker.apiverve.com?utm_source=go&utm_medium=readme
package sslchecker
...
// Request contains the parameters for the SSL Certificate Checker API.
//
// Parameters:
//   - domain (required): string - The domain of the website to check the SSL certificate of
type Request struct {
...
// ResponseData contains the data returned by the SSL Certificate Checker API.
type ResponseData struct {
	Subject SubjectData `json:"subject"`
	Issuer IssuerData `json:"issuer"`
	Subjectaltname string `json:"subjectaltname"`
	InfoAccess InfoAccessData `json:"infoAccess"`
	Ca bool `json:"ca"`
	Bits int `json:"bits"`
...
// IssuerData represents the issuer object.
...
// InfoAccessData represents the infoAccess object.
type InfoAccessData struct {
	CA Issuers - URI []string `json:"CA Issuers - URI"`
	OCSP - URI []string `json:"OCSP - URI"`
}
