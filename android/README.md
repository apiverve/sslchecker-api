# SSL Certificate Checker Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:sslchecker-api:1.1.13'
}
```
...
```java
import com.apiverve.sslchecker.SSLCertificateCheckerAPIClient;
import com.apiverve.sslchecker.APIResponse;
import com.apiverve.sslchecker.APIException;

// Initialize the client
SSLCertificateCheckerAPIClient client = new SSLCertificateCheckerAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("domain", "ebay.com");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/sslchecker](https://docs.apiverve.com/ref/sslchecker)
...
- **Documentation:** [https://docs.apiverve.com/ref/sslchecker](https://docs.apiverve.com/ref/sslchecker)
- **Issues:** [GitHub Issues](https://github.com/apiverve/sslchecker-api/issues)
