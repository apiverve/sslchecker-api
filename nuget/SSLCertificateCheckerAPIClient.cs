...
namespace APIVerve.API.SSLCertificateChecker
{
    ...
    /// <summary>
    /// Client for the SSLCertificateChecker API
    /// </summary>
    public class SSLCertificateCheckerAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/sslchecker";
        ...
        public SSLCertificateCheckerAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public SSLCertificateCheckerAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public SSLCertificateCheckerAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, SSLCertificateCheckerQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(SSLCertificateCheckerQueryOptions options)
        {
        ...
        public ResponseObj Execute(SSLCertificateCheckerQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(SSLCertificateCheckerQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(SSLCertificateCheckerQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(SSLCertificateCheckerQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(SSLCertificateCheckerQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(SSLCertificateCheckerQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(SSLCertificateCheckerQueryOptions options)
        {
