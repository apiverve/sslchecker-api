# SSL Certificate Checker API - Examples

This folder contains example code for using the SSL Certificate Checker API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/sslchecker',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/sslchecker");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/sslchecker](https://docs.apiverve.com/ref/sslchecker)
